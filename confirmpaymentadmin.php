...
$( document ).ready(function() {
	...
	<body>
		...
		<?php include("headeradmin.php"); ?>
			...
			<div id="contentadmin">
				<div class="headercontentadmin">Confirm Payment</div>
				<div class="clear"></div>
				<div class="fieldcontentadmin">
					<?php include('headerevent.php'); ?>
					<div>
						<form method="post" action="confirmpaymentadmin.php">
                        <div align="center" class="font">
                        Search Confirmation Payment by Event Title
						...
						<table class="tableadmin">
							...
							?>
									<tr align="center" <?php if($i % 2 ==1) echo 'class="colortablecontent"'?>  >
										...
										<td class="popup">
											<a href="popup/confirmPaymentAdmin.php?EventTitle=<?php echo $row['EventTitle']?>&EventID=<?php echo $row[0];?>" class="confirmPayment"> <input type="button" value="View" /> </a>	
										</td>
