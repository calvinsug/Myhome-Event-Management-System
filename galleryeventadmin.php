...
$( document ).ready(function() {
	...
	<body>
		...
		<?php include("headeradmin.php"); ?>
			...
			<div id="contentadmin">
				<div class="headercontentadmin">Gallery</div>
				<div class="clear"></div>
				<div class="fieldcontentadmin">
					<?php include('headerevent.php'); ?>
					<div>
						<form method="post" action="galleryeventadmin.php">
                        <div align="center" class="font">
                        Search Gallery by Event Title
						...
						<table class="tableadmin">
							...
							?>
									<tr align="center" <?php if($i % 2 ==1) echo 'class="colortablecontent"'?>  >
										...
										<td class="popup">
											<a href="popup/viewGallery.php?EventID=<?php echo $row[0];?>" class="viewGallery"> <input type="button" value="View" /> </a>
											
											<?php if($StaffRole != "President"){ ?>
											<a href="popup/addGallery.php?EventID=<?php echo $row[0];?>" class="addGallery"> <input type="button" value="Add" /> </a>
											<?php }?>
										</td>
