...
$( document ).ready(function() {
	...
	<body>
		...
		<?php include("headeradmin.php"); ?>
			...
			<div id="contentadmin">
				<div class="headercontentadmin">Rundown</div>
				<div class="clear"></div>
				<div class="fieldcontentadmin">
					<?php include('headerevent.php'); ?>
					<div>
						<form method="post" action="rundownadmin.php">
                        <div align="center" class="font">
                        Search Rundown by Event Title
						...
						<table class="tableadmin">
							...
							?>
									<tr align="center" <?php if($i % 2 ==1) echo 'class="colortablecontent"'?>  >
										...
										<td class="popup">
											<a href="popup/viewRundown.php?EventTitle=<?php echo $row['EventTitle']?>&EventID=<?php echo $row[0];?>" class="viewRundown"> <input type="button" value="View" /> </a>
											<?php if($StaffRole != "President"){?>
											<a href="popup/addRundown.php?EventID=<?php echo $row[0];?>" class="createRundown"> <input type="button" value="Create" /> </a>
											<?php } ?>
											<input type="button" href="popup/printRundown.php?EventTitle=<?php echo $row['EventTitle']?>&EventID=<?php echo $row[0];?>" class="printRundown" value="print">
										</td>
