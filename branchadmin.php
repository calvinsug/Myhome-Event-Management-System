		...
		<div id="container">
			...
			<div id="contentadmin">
				...
				<div class="fieldcontentadmin">
					...
					<div>
						<form method="post" action="branchadmin.php">
                        <div align="center" class="font">
                        Search Branch by Address
						...
						<table class="tableadmin">
							...
							?>
								<tr align="center">
									...
									<?php if($StaffRole != "President"){?>
									<td class="popup"><a href="popup/updateBranch.php?id=<?php echo $row['BranchID'];?>&
										lat=<?php echo $row['BranchLatitude'];?>&
										lng=<?php echo $row['BranchLongitude'];?>&
										address=<?php echo $row['BranchAddress'];?>&
										staffid=<?php echo $row['StaffID'];?>&
										region=<?php echo $row['Region'];?>" data-fancybox-type="iframe" class="updateBranch">
