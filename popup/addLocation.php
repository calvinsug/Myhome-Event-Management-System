		...
		<script>
			...
			$( document ).ready(function() {
			 	...
			 	$('.btnAddLocation').click(function(){
			 		...
			 		$.ajax({
						url: "../controller/doCreateLocation.php",
						type: "POST",
						dataType: "json",
						...
						success: function(data){
							if(data == '1'){
								...
								alert('Create new Location success.');
								//$('.fancybox-close');
	...
	<body>
			...
			<div id="popup">
				<div class="form">
						...
						<div class="field">
							<div class="submit"><input type="button" class="btnAddLocation" value="Create Location" class="sizesubmit"/></div>
						</div>
						<br/><br/>
