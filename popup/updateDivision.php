...
<html>
	...
	<body>
			...
			<div id="popup">
				<div class="form">
					<form method="post" action="../controller/doUpdateDivision.php" id="formRegis">
			
							<div id="newRundown">
							<div class="field">
								<h2 align="center">Update Division</h2>
								<hr/>
							</div>
							<br/>
								...
								<div class="dayForm">
									...
									<div class="rundown">
										...
										<div class="field" style="display:none">
											...
											<span><input id="title" name="DivisionID" value="<?php echo $DivisionID;?>" class="textbox" type="text"/></span>
										</div>
										
										<div class="field">
											<span>Division Name</span>
											<span><input id="DivisionName" name="DivisionName" value="<?php echo $DivisionName;?>" class="textbox" type="text"/></span>
										</div>
							...
							<div class="field">
								...
								<div class="submit"><input type="submit" class="btnUpdateDivision" value="Update Division" class="sizesubmit"/></div>
