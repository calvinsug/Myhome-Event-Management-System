...
<html>
	...
	<body>
			...
			<div id="popup">
				<div class="form">
					<form method="post" action="../controller/doAddBudget.php" id="formRegis">
			
							<div id="newRundown">
							<div class="field">
								<h2 align="center">Add Budget Division</h2>
								<hr/>
							</div>
							<br/>
								...
								<div class="dayForm">
									...
									<div class="rundown">
										...
										<div class="field">
											...
											<span><input name="budgetdesc" class="textbox" type="text"/></span>
										</div>

										<div class="field">
											<span>Budget Expected</span>
											<span><input name="budgetexpected" class="textbox" type="text"/></span>
										</div>
							...
							<div class="field">
								...
								<div class="submit"><input type="submit" class="btnAddMemberDivision" value="Add Budget" class="sizesubmit"/></div>
