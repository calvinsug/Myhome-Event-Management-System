					...
					<form method="post" action="../controller/doCreateRundown.php" id="formRegis">
							...
							?>
								...
								<?php } // end of pisahin location?>
									...
									<a href="../controller/doDeleteRundown.php?RundownID=<?php echo $row['RundownID'];?>&EventTitle=<?php echo $EventTitle;?>&LocationID=<?php echo $row['LocationID'];?>&EventID=<?php echo $EventID;?>" class="delete">
