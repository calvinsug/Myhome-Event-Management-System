...
<html>
	...
	<body>
			...
			<div id="popup">
				<div class="form">
					<form method="post" action="../controller/doChangePasswordAdmin.php" id="formRegis">
							...
							<div class="field">
								...
								<div class="submit"><input type="submit" class="btnAddMemberDivision" value="Change Password" class="sizesubmit"/></div>
