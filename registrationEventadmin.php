...
$( document ).ready(function() {
	...
	$('.viewEventRegistration').fancybox({
		maxWidth	: 800,
		maxHeight	: 450,
		fitToView	: false,
		width		: '70%',
	...
	<body>
		...
		<?php include("headeradmin.php"); ?>
			...
			<div id="contentadmin">
				<div class="headercontentadmin">Event Registration</div>
				<div class="clear"></div>
				<div class="fieldcontentadmin">
					<?php include('headerevent.php'); ?>
					<div>
						<form method="post" action="registrationEventadmin.php">
                        <div align="center" class="font">
                        Search Registration Event by Event Title
							...
							?>
									<tr align="center" <?php if($i % 2 ==1) echo 'class="colortablecontent"'?>  >
										...
										<td class="popup">
											...
											<a href="popup/viewEventRegistration.php?EventTitle=<?php echo $row['EventTitle']?>&EventID=<?php echo $row['EventID'];?>" class="viewEventRegistration">
												<input type="button" value="View" />
											</a>

											<input type="button" value="Print" class="btnView" href="popup/viewEventReport.php?EventID=<?php echo $row['EventID'];?>"/> 
