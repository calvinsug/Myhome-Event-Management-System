...
*/
	...
	if($error==""){
		...
		$query = "update Branch set BranchLatitude='$BranchLatitude', BranchLongitude='$BranchLongitude' ,
		 BranchAddress = '$BranchAddress', Region = '$Region',StaffID = '$StaffID' where BranchID ='$BranchID'";
