...
*/			 
	...
	<body>
		<div id="container">
			...
			<div id="content">
				<div class="form">
					<form method="post" action="controller/doregis.php" id="formRegis" enctype="multipart/form-data">
						<div class="field">
						...
						<br/><br/>
						<div class="field">
							<div class="submit"><input type="submit" value="Register" class="button btnSubmit"/></div>
